...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg font-sans text-gray-900 dark:text-dark-text">
      {/* Header */}
      <header className="h-16 border-b border-apple-gray-200 dark:border-dark-border bg-white/80 dark:bg-dark-surface/80 backdrop-blur-md sticky top-0 z-10 flex items-center justify-between px-6 shadow-sm">
        <div className="flex items-center">
          <h1 className="text-xl font-semibold text-apple-gray-800 dark:text-dark-text">
            <span className="text-primary dark:text-primary-accent">Imager</span>
          </h1>
          <div className="ml-3 text-xs font-medium bg-apple-gray-100 dark:bg-dark-border text-apple-gray-600 dark:text-dark-textMuted px-2.5 py-1 rounded-full">Real-time Effects</div>
        </div>
        <div className="flex gap-4">
          <a 
            ...
            className="text-sm text-apple-gray-600 dark:text-dark-textMuted hover:text-apple-gray-800 dark:hover:text-dark-text flex items-center transition-colors"
          >
        ...
        <div className="w-80 border-r border-apple-gray-200 dark:border-dark-border bg-white/80 dark:bg-dark-surface/80 backdrop-blur-sm overflow-y-auto flex flex-col shadow-sm">
          ...
          <div className="p-5 border-b border-apple-gray-200 dark:border-dark-border">
            <button 
              ...
              className="w-full inline-flex items-center justify-center px-4 py-2 bg-primary dark:bg-primary-accent hover:bg-opacity-90 dark:hover:bg-opacity-90 text-white text-sm font-medium rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="flex-1 relative overflow-hidden bg-apple-gray-50 dark:bg-dark-bg">
          {imageLoading ? (
            <div className="absolute inset-0 flex flex-col items-center justify-center text-apple-gray-400 dark:text-dark-textMuted">
              <svg className="animate-spin h-12 w-12 text-primary dark:text-primary-accent" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-red-500 dark:text-apple-red">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-apple-gray-400 dark:text-dark-textMuted">
              <div className="w-32 h-32 mb-8 rounded-2xl bg-apple-gray-100 dark:bg-dark-surface flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              <h2 className="text-xl font-medium text-apple-gray-800 dark:text-dark-text mb-3">Drop Image or Click to Upload</h2>
              <p className="text-sm text-apple-gray-500 dark:text-dark-textMuted mb-8 max-w-md text-center">
                Supported formats: JPG, PNG, GIF, WebP
              </p>
              <label className="btn-apple-primary dark:bg-primary-accent dark:hover:bg-opacity-90 cursor-pointer px-4 py-2 text-white text-sm font-medium rounded-md transition-colors">
                <input
                  type="file"
                  accept="image/*"
                  className="hidden"
