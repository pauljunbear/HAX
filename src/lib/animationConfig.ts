  ...
  delaunay: {
    ...
    animationPresets: [
      ...
      },
      {
        ...
        frameRate: 30,
        parameterCurves: {
          numPoints: (progress) => 50 + Math.floor(Math.sin(progress * Math.PI * 2) * 40) // Oscillate between 50-90 points
        }
      }
    ]
  },
  ...
  fractalDisplacement: {
    ...
    animationPresets: [
      ...
      },
      {
        ...
        frameRate: 24,
        parameterCurves: {
          strength: (progress) => 50 + Math.sin(progress * Math.PI * 6) * 50 + Math.sin(progress * Math.PI * 13) * 30,
