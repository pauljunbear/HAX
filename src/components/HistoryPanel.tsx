    ...
    <div className="border-t border-dark-border bg-dark-surface">
      <div className="py-3 px-5 border-b border-dark-border">
        ...
        <div className="flex items-center space-x-3 mt-3">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1 inline-block align-middle" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            Redo
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 ml-1 inline-block align-middle" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {history.length === 0 ? (
            ...
            <div className="space-y-1.5">
              {history.map((state, index) => (
                ...
                >
                  <div className={`font-medium truncate ${index === currentIndex ? 'text-primary-accent' : 'text-dark-text'}`}>{state.activeEffect ? (effectsConfig[state.activeEffect]?.label || state.activeEffect) : 'Initial State'}</div>
